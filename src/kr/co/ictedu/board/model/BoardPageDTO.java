...
// VO와 DTO는 크게 구분을 하지 않는 사람들도 있고 구분을 한닥고 해도
// 엄격하게 하지는 않는 편입니다.
// 만약 굳이 구분을 해야 한다면, VO는 DB에서 받아온 데이터를 그대로 전달하는 쪽에
...
public class BoardPageDTO {
	...
	// 생성자는 전체 글 개수, 현재 페이지, 페이징 된 글 목록을 받아서 가공해
	// 니머지 정보를 얻어냅니다.
	...
	{
		return boardList; // 해당 페이지 표시할 글 목록 리턴
	}
